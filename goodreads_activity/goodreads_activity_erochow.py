...
class GoodreadsActivity:
    def __init__(self, generator):
        ...
        print("initializing GoodreadsActivity class")
        ...
        print("self.activities is good to go")
...
def fetch_goodreads_activity(gen, metadata):
    print("fetch_goodreads_activity loaded")
    if (
        ...
        print("Trying to grab all specified shelves.")
        logger.debug("Settings: %s", gen.settings)
        print("Settings: " + gen.settings)
        ...
        print("ACTIVITY: " + gen.context["goodreads_activity"])
        ...
        print("Grabbing activity for single specified feed")
...
def register():
    ...
    try:
        ...
        print("Initializing feedparser")
        signals.page_generator_init.connect(initialize_feedparser)
